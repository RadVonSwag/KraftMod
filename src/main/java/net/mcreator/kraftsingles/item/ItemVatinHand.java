...
public class ItemVatinHand extends ElementsKraftSingles.ModElement {
	@GameRegistry.ObjectHolder("kraftsingles:vatinhand")
	public static final Item block = null;
	public ItemVatinHand(ElementsKraftSingles instance) {
		super(instance, 46);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("kraftsingles:vatinhand", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("vatinhand");
			setRegistryName("vatinhand");
