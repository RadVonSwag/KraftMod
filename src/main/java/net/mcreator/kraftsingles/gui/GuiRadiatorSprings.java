...
import net.mcreator.kraftsingles.procedure.ProcedureTakingJar;
import net.mcreator.kraftsingles.procedure.ProcedureRadiatorNeighbourBlockChanges;
...
public class GuiRadiatorSprings extends ElementsKraftSingles.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiRadiatorSprings(ElementsKraftSingles instance) {
		super(instance, 76);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 80, 21) {
				@Override
				...
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemAmiiboInAJar.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 80, 57) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				KraftSingles.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("kraftsingles:textures/radiatorsprings.png");
		@Override
		...
		protected void actionPerformed(GuiButton button) {
			KraftSingles.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (slotID == 0 && changeType == 0) {
			{
				...
				ProcedureRadiatorNeighbourBlockChanges.executeProcedure($_dependencies);
			}
		}
		if (slotID == 1 && changeType == 1) {
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("entity", entity);
				ProcedureTakingJar.executeProcedure($_dependencies);
			}
		}
	}
}
